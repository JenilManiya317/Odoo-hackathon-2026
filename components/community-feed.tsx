...
export function CommunityFeed() {
  ...
  function describeDatabaseError(message: string) {
    return message.includes('community_') || message.includes('relation')
      ? 'Community publishing is temporarily unavailable. Please try again later.'
  ...
  async function createPost(event: FormEvent) {
    ...
    setPostTitle(''); setPostBody(''); setSuccess('Your story was published successfully.')
  }
